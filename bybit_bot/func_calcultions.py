...
def get_trade_details(orderbook, direction="Long", capital=0):
    ...
    if orderbook:
        ...
        # Set price rounding
        price_rounding = rounding_ticker_1 if symbol == ticker_1 else rounding_ticker_2
        quantity_rounding = quantity_rounding_ticker_1 if symbol == ticker_1 else quantity_rounding_ticker_2
    ...
    # Output results
    return (symbol, mid_price, stop_loss, quantity)
